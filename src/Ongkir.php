...
class Ongkir
{
    protected $baseurl_starter = 'https://api.rajaongkir.com/starter';
    protected $baseurl_basic = 'https://api.rajaongkir.com/basic';
    protected $baseurl_pro = 'https://pro.rajaongkir.com/api';
